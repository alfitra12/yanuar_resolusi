...
-->
 ...
 <section class="contact-page">
    ...
    <form method="post">
      <h2>DAFTAR SEBAGAI USER  <small>Sebelum mengisi from pendaftaran di wajibkan mendaftar sebagai user</small></h2>
      <hr class="colorgraph">
      <br>
      <div class="form-group">
          <h4 class="card-title">NAMA PENDAFTAR USER</h4>
      ...
      <div class="form-group">
        ...
        <input type="text" name="hp" id="hp" class="form-control input-lg">
      </div>
        <div class="form-group">
...
{
  $koneksi->query("INSERT INTO tb_daftaruser (nama,email,hp,password) 
  VALUES('$_POST[nama]','$_POST[email]','$_POST[hp]','$_POST[password]')");
